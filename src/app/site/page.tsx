...
export default async function Home() {
	...
	return (
		<>
			<section className="w-full md:pt-40 pt-32 relative flex items-center justify-center flex-col">
				{/* grid */}
			...
			<section className="flex justify-center items-center flex-col gap-4 md:!mt-20 mt-40">
